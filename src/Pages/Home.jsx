    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="mt-16 border-t border-white/10 pt-8 pb-10 text-center">
        <button
          ...
          className="inline-flex items-center justify-center rounded-full border border-white/10 bg-white/5 px-5 py-2 text-sm text-white/70 hover:bg-white/10 transition"
        >
          Legal Information
        </button>
      </div>
